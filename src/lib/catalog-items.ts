...
export const CATALOG_ITEMS: CatalogItem[] = [
  ...
  // ── 수산 ──────────────────────────────────────────────
  { id: "hairtail", name: "갈치", category: "수산", auctionUnit: "1kg", weightKg: 1, consumerUnit: "1마리", kgPerConsumerUnit: 0.5, grade: "상", origin: "제주 위판", unitVerified: true, verificationNote: "KAMIS 도매 단위 \"1kg\" = 1kg 일치" },
  { id: "mackerel", name: "고등어", category: "수산", auctionUnit: "10kg", weightKg: 10, consumerUnit: "1마리", kgPerConsumerUnit: 0.4, grade: "상", origin: "부산 위판", unitVerified: true, verificationNote: "KAMIS 도매 단위 \"10kg\" = 10kg 일치" },
  { id: "cockle", name: "꼬막", category: "수산", auctionUnit: "1kg", weightKg: 1, consumerUnit: "1kg", kgPerConsumerUnit: 1, grade: "상", origin: "국내 위판", unitVerified: false, verificationNote: "KAMIS 도매 시세 없음 (소매 단위 \"1kg\"만 존재) — 경락가 원천이 없다" },
  { id: "saury", name: "꽁치", category: "수산", auctionUnit: "5마리", weightKg: 0.3, consumerUnit: "1마리", kgPerConsumerUnit: 0.4, grade: "상", origin: "국내 위판", unitVerified: false, verificationNote: "KAMIS 도매 시세 없음 (소매 단위 \"5마리\"만 존재) — 경락가 원천이 없다 / 소비자단위 1마리(0.4kg) > 거래단위 전체(0.3kg)" },
  { id: "blue-crab", name: "꽃게", category: "수산", auctionUnit: "1kg", weightKg: 1, consumerUnit: "1kg", kgPerConsumerUnit: 1, grade: "상", origin: "국내 위판", unitVerified: false, verificationNote: "KAMIS 도매 시세 없음 (소매 단위 \"1kg\"만 존재) — 경락가 원천이 없다" },
  { id: "octopus", name: "낙지", category: "수산", auctionUnit: "100g", weightKg: 1, consumerUnit: "100g", kgPerConsumerUnit: 0.1, grade: "상", origin: "국내 위판", unitVerified: false, verificationNote: "KAMIS 도매 시세 없음 (소매 단위 \"100g\"만 존재) — 경락가 원천이 없다 / auctionUnit \"100g\"(0.1kg) ≠ weightKg=1" },
  { id: "pollock", name: "명태", category: "수산", auctionUnit: "20kg", weightKg: 20, consumerUnit: "1마리", kgPerConsumerUnit: 0.6, grade: "상", origin: "속초 위판", unitVerified: true, verificationNote: "KAMIS 도매 단위 \"20kg\" = 20kg 일치" },
  { id: "squid", name: "물오징어", category: "수산", auctionUnit: "1kg", weightKg: 1, consumerUnit: "1마리", kgPerConsumerUnit: 0.27, grade: "상", origin: "동해 위판", unitVerified: true, verificationNote: "KAMIS 도매 단위 \"1kg\" = 1kg 일치" },
  { id: "clam", name: "바지락", category: "수산", auctionUnit: "1kg", weightKg: 1, consumerUnit: "1kg", kgPerConsumerUnit: 1, grade: "상", origin: "국내 위판", unitVerified: false, verificationNote: "KAMIS 도매 시세 없음 (소매 단위 \"1kg\"만 존재) — 경락가 원천이 없다" },
  { id: "spanish-mackerel", name: "삼치", category: "수산", auctionUnit: "1kg", weightKg: 1, consumerUnit: "1마리", kgPerConsumerUnit: 0.4, grade: "상", origin: "국내 위판", unitVerified: true, verificationNote: "KAMIS 도매 단위 \"1kg\" = 1kg 일치" },
  { id: "shrimp", name: "새우", category: "수산", auctionUnit: "2kg", weightKg: 2, consumerUnit: "100g", kgPerConsumerUnit: 0.1, grade: "상", origin: "충남 태안", unitVerified: true, verificationNote: "KAMIS 도매 단위 \"2kg\" = 2kg 일치" },
  { id: "imported-croaker", name: "수입조기", category: "수산", auctionUnit: "1마리", weightKg: 0.3, consumerUnit: "1마리", kgPerConsumerUnit: 0.4, grade: "상", origin: "국내 위판", unitVerified: false, verificationNote: "KAMIS 도매 시세 없음 (소매 단위 \"1마리\"만 존재) — 경락가 원천이 없다 / 소비자단위 1마리(0.4kg) > 거래단위 전체(0.3kg)" },
  { id: "abalone", name: "전복", category: "수산", auctionUnit: "1kg", weightKg: 1, consumerUnit: "1마리", kgPerConsumerUnit: 0.08, grade: "상", origin: "국내 위판", unitVerified: true, verificationNote: "KAMIS 도매 단위 \"1kg\" = 1kg 일치" },
  { id: "croaker", name: "조기", category: "수산", auctionUnit: "1마리", weightKg: 0.3, consumerUnit: "1마리", kgPerConsumerUnit: 0.4, grade: "상", origin: "국내 위판", unitVerified: false, verificationNote: "KAMIS 도매 시세 없음 (소매 단위 \"1마리\"만 존재) — 경락가 원천이 없다 / 소비자단위 1마리(0.4kg) > 거래단위 전체(0.3kg)" },
  { id: "mussel", name: "홍합", category: "수산", auctionUnit: "1kg", weightKg: 1, consumerUnit: "1kg", kgPerConsumerUnit: 1, grade: "상", origin: "국내 위판", unitVerified: true, verificationNote: "KAMIS 도매 단위 \"1kg\" = 1kg 일치" },
];
