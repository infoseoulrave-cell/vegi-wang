...
export const CATALOG_ITEMS: CatalogItem[] = [
  ...
  { id: "melon", name: "멜론", category: "채소", auctionUnit: "8kg", weightKg: 8, consumerUnit: "1개", kgPerConsumerUnit: 1.5, grade: "상", origin: "국내산", aliases: { garak: ["메론"] }, unitVerified: true, verificationNote: "KAMIS 도매 단위 \"8kg\" = 8kg 일치" },
  ...
  { id: "watermelon", name: "수박", category: "채소", auctionUnit: "10kg", weightKg: 10, consumerUnit: "1통", kgPerConsumerUnit: 8, grade: "상", origin: "충남 부여", unitVerified: true, verificationNote: "가락 실측 거래단량 최빈 \"10kg\" 209/1085행 (2026-08-03) — 행 단위 원/kg 환산이 자기완결" },
  ...
  { id: "garlic-bulb", name: "피마늘", category: "채소", auctionUnit: "20kg", weightKg: 20, consumerUnit: "1kg", kgPerConsumerUnit: 1, grade: "상", origin: "국내산", aliases: { garak: ["마늘"] }, unitVerified: true, verificationNote: "가락 실측 거래단량 최빈 \"20kg\" 75/77행 (2026-08-03) — 행 단위 원/kg 환산이 자기완결" },
  ...
  { id: "kiwi-imported", name: "참다래(수입)", category: "과일", queryName: "참다래", auctionUnit: "6kg", weightKg: 6, consumerUnit: "1개", kgPerConsumerUnit: 0.1, grade: "특", origin: "뉴질랜드", unitVerified: true, verificationNote: "가락 실측 거래단량 최빈 \"6kg\" 31/49행 (2026-07-20~08-03) — 행 단위 원/kg 환산이 자기완결" },
  { id: "avocado-imported", name: "아보카도(수입)", category: "과일", queryName: "아보카도", auctionUnit: "5kg", weightKg: 5, consumerUnit: "1개", kgPerConsumerUnit: 0.2, grade: "특", origin: "수입", unitVerified: true, verificationNote: "가락 실측 거래단량 최빈 \"5kg\" 1/1행 (2026-07-20~08-03) — 행 단위 원/kg 환산이 자기완결" },
  { id: "banana-imported", name: "바나나(수입)", category: "과일", queryName: "바나나", auctionUnit: "13kg", weightKg: 13, consumerUnit: "1송이", kgPerConsumerUnit: 1.2, grade: "특", origin: "필리핀", unitVerified: true, verificationNote: "KAMIS 품목명 \"바나나\"로 매칭 / KAMIS 도매 단위 \"13kg\" = 13kg 일치" },
  { id: "lemon-imported", name: "레몬(수입)", category: "과일", queryName: "레몬", auctionUnit: "18kg", weightKg: 18, consumerUnit: "1개", kgPerConsumerUnit: 0.1, grade: "특", origin: "칠레", unitVerified: true, verificationNote: "가락 실측 거래단량 최빈 \"18kg\" 20/29행 (2026-07-20~08-03) — 행 단위 원/kg 환산이 자기완결" },
  { id: "pineapple-imported", name: "파인애플(수입)", category: "과일", queryName: "파인애플", auctionUnit: "12kg", weightKg: 12, consumerUnit: "1개", kgPerConsumerUnit: 1.5, grade: "특", origin: "필리핀", unitVerified: true, verificationNote: "KAMIS 품목명 \"파인애플\"로 매칭 / KAMIS 도매 단위 \"12kg\" = 12kg 일치" },
